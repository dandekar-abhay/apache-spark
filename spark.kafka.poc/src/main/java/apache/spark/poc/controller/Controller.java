...
public class Controller {
  ...
  // Enter your jar path location here
  private final String jarPath =
      "/home/abhay/MyHome/WorkArea/CodeHome/Apache/Spark/MyCodeEgs/Java/apache-spark/spark.kafka.poc/target/kafka.poc-0.0.3-SNAPSHOT.jar";

  private void execute() {
    SparkLauncher launcher = new SparkLauncher().setAppResource(jarPath)
        .setMainClass("apache.spark.poc.SparkStructuredStreamProcessor")
        .setMaster("local[2]").setConf(SparkLauncher.DRIVER_MEMORY, "1g")
